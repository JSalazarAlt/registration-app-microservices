...
describe('UserService', () => {
    ...
    describe('getUserProfile', () => {
        it('Should successfully retrieve user profile by account ID', async () => {
            ...
            const result = await service.getAuthenticatedUser(accountId);
        ...
        it('Should throw HttpException when profile not found', async () => {
            ...
            await expect(service.getAuthenticatedUser(accountId)).rejects.toThrow(HttpException);
        });
    });
    ...
    describe('updateUserProfile', () => {
        it('should successfully update user profile', async () => {
            ...
            const result = await service.updateAuthenticatedUser(accountId, updateData);
        ...
        it('should throw HttpException when update fails', async () => {
            ...
            await expect(service.updateAuthenticatedUser(accountId, updateData)).rejects.toThrow(HttpException);
        });
    });
    ...
    describe('handleServiceError', () => {
        it('should handle service unavailable error', async () => {
            ...
            await expect(service.getAuthenticatedUser(accountId)).rejects.toThrow(
